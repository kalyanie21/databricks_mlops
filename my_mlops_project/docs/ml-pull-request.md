...
Links:
* [Staging model in UC](https://adb-625131611825264.4.azuredatabricks.net/explore/data/models/staging/my_mlops_project/my_mlops_project-model)
* [Prod model in UC](https://adb-625131611825264.4.azuredatabricks.net/explore/data/models/prod/my_mlops_project/my_mlops_project-model)
. 
